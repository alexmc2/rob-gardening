...
export type AllSanitySchemaTypes = ReviewsCarousel | LottieAnimation | MenuGoogleSection | MenuSection | AllPosts | LocationMap | FormContactMap | FormContact | FormNewsletter | Faqs | LogoCloud1 | Cta1 | Timelines1 | TimelineRow | BeforeAfterGallery | CloudinaryGallery | ImageGallery | Carousel2 | Carousel1 | ShopBrowser | ProductGrid | GridRow | GridPost | PricingCard | GridCard | SplitLocationMap | SplitContactForm | SplitInfo | SplitInfoList | SplitImage | SplitCard | SplitCardsList | SplitContent | SplitRow | RichTextBlock | SectionHeader | HeroFull | Hero2 | Hero1 | CloudinaryGalleryImage | ProductVariant | HeroFlex | SectionPadding | ButtonVariant | ColorVariant | Link | BlockContent | Product | Settings | Navigation | Testimonial | Faq | Category | Page | Collection | LottieAsset | Post | Author | Code | SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageHotspot | SanityImageCrop | SanityFileAsset | SanityImageAsset | SanityImageMetadata | Geopoint | Slug | SanityAssetSourceData;
