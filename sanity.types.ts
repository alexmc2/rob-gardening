...
export type Booking = {
  ...
  availability?: Array<{
    ...
    _weak?: boolean;
    _key: string;
    [internalGroqTypeReferenceTo]?: "bookingAvailability";
  }>;
  slotKey?: string;
  slotStart?: string;
  slotEnd?: string;
...
export type AllSanitySchemaTypes = TestimonialsCarousel | LottieAnimation | MenuGoogleSection | MenuSection | AllPosts | LocationMap | FormContactMap | FormBookingCalendar | FormBooking | FormContact | FormNewsletter | Faqs | LogoCloud1 | Cta1 | Timelines1 | TimelineRow | BeforeAfterGallery | CloudinaryGallery | ImageGallery | Carousel2 | Carousel1 | ShopBrowser | ProductGrid | GridRow | GridPost | PricingCard | GridCard | SplitLocationMap | SplitContactForm | SplitInfo | SplitInfoList | SplitImage | SplitCard | SplitCardsList | SplitContent | SplitRow | RichTextBlock | SectionHeader | HeroFull | Hero2 | Hero1 | CloudinaryGalleryImage | BookingSlot | ProductVariant | HeroFlex | SectionPadding | ButtonVariant | ColorVariant | Link | BlockContent | Product | Booking | BookingAvailability | BookingSettings | Settings | Navigation | Testimonial | Faq | Category | Page | Collection | LottieAsset | Post | Author | Code | SanityImagePaletteSwatch | SanityImagePalette | SanityImageDimensions | SanityImageHotspot | SanityImageCrop | SanityFileAsset | SanityImageAsset | SanityImageMetadata | Geopoint | Slug | SanityAssetSourceData;
...
// Source: ./sanity/queries/booking-availability.ts
// Variable: BOOKING_AVAILABILITY_BY_ID_QUERY
// Query: *[_type == "bookingAvailability" && _id == $id][0]{    _id,    title,    timezone,    slots[]{      _key,      start,      end,      capacity,      note,      "bookedCount": count(*[        _type == "booking"        && references(^._id)        && slotKey == ^._key        && status != "cancelled"      ])    }  }
export type BOOKING_AVAILABILITY_BY_ID_QUERYResult = {
  _id: string;
  title: string | null;
...
// Query: *[_type == "bookingSettings" && _id == $id][0]{      _id,  title,  servicePostcode,  serviceRadiusKm,  serviceLocation,  serviceAreaLabel,  successMessage,  notificationEmail,  "availability": availabilityCalendars[0]->{    _id,    title,    timezone,  },  }
...
// Query: *[_type == "bookingSettings"][0]{      _id,  title,  servicePostcode,  serviceRadiusKm,  serviceLocation,  serviceAreaLabel,  successMessage,  notificationEmail,  "availability": availabilityCalendars[0]->{    _id,    title,    timezone,  },  }
...
declare module "@sanity/client" {
  interface SanityQueries {
    ...
    "\n  *[_type == \"bookingAvailability\" && _id == $id][0]{\n    _id,\n    title,\n    timezone,\n    slots[]{\n      _key,\n      start,\n      end,\n      capacity,\n      note,\n      \"bookedCount\": count(*[\n        _type == \"booking\"\n        && references(^._id)\n        && slotKey == ^._key\n        && status != \"cancelled\"\n      ])\n    }\n  }\n": BOOKING_AVAILABILITY_BY_ID_QUERYResult;
    "\n  *[_type == \"bookingSettings\" && _id == $id][0]{\n    \n  _id,\n  title,\n  servicePostcode,\n  serviceRadiusKm,\n  serviceLocation,\n  serviceAreaLabel,\n  successMessage,\n  notificationEmail,\n  \"availability\": availabilityCalendars[0]->{\n    _id,\n    title,\n    timezone,\n  },\n\n  }\n": BOOKING_SETTINGS_BY_ID_QUERYResult;
